...
@section('title', 'Edit Short Link - LPM Ibnu Rusyd')
@section('content')
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <div class="p-6 border-b border-gray-200">
            <h2 class="text-lg font-medium text-gray-900">Edit Short Link</h2>
            <p class="mt-1 text-sm text-gray-600">Perbarui data short link di bawah.</p>
        </div>

        <form action="{{ route('shortlinks.update', $link->id) }}" method="POST" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <div class="flex">
                        ...
                        <input type="text" name="slug" id="slug" value="{{ old('slug', $link->slug) }}"
